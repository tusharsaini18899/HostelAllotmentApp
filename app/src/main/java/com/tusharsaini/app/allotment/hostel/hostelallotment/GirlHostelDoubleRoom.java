...
public class GirlHostelDoubleRoom extends AppCompatActivity {
    ...
    RadioButton ahilya,saraswati,tarawati,one,two;

    Button next,back;

    ProgressDialog dialog;

    final String URL = "https://hostelallotment12345.000webhostapp.com/doubleroomgirlhostel.php";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.girlhosteldoubleroom);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back=new Intent(GirlHostelDoubleRoom.this,HostelType.class);
                startActivity(back);
            }
        });
        ...
        dialog = new ProgressDialog(GirlHostelDoubleRoom.this);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(GirlHostelDoubleRoom.this, "Please! Enter all the values", Toast.LENGTH_SHORT).show();
                }
               else
                {
                    ...
                    RequestQueue requestQueue= Volley.newRequestQueue(GirlHostelDoubleRoom.this);
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if(connectionStatus.equals("CONN_SUCCESS"))
                                {
                                    ...
                                    {
                                        Toast.makeText(GirlHostelDoubleRoom.this, "Dear "+name1+" ! Roomnumber "+roomNumber1+" in "+finalHostelname+" is Alloted Successfully", Toast.LENGTH_LONG).show();
                                        Intent a=new Intent(GirlHostelDoubleRoom.this,SliderMainPage.class);
                                        startActivity(a);
                                        finish();
                                        dialog.dismiss();
                                    }
                                    ...
                                    {
                                        Toast.makeText(GirlHostelDoubleRoom.this, "Dear "+name1+"! Submission Failed !", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                    }
                                ...
                                {
                                    Toast.makeText(GirlHostelDoubleRoom.this, "Connection Error", Toast.LENGTH_SHORT).show();
                                    dialog.dismiss();
                                }
